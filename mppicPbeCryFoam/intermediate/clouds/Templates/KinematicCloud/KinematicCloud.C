...
(
    ...
    const volScalarField& supersat,
    const volScalarField& R_growth,
    const volScalarField& R_nucleation,
...
:
    ...
    U_(c.U_),
    mu_(c.mu_),
    supersat_(c.supersat_),
    R_growth_(c.R_growth_),
    R_nucleation_(c.R_nucleation_),
    g_(c.g_),
